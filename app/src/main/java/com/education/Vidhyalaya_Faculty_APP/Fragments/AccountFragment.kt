...
import com.education.Vidhyalaya_Faculty_APP.API.Accountapi
...
class AccountFragment : Fragment() {
            ...
            override fun onResponse(
                ...
                if(response.isSuccessful) {
                    ...
                    Picasso.with(context)
                        .load(
                            "http://vidhyalaya.co.in/sspanel/" + response.body()!!.get(0).profileimage
                        )
    ...
    fun functionwithoutimage() {
        ...
        progressDialog.show()
            ...
            var preferences = Services()
            val loginResponseCall: Call<Profileupdateapi> =
                preferences.getaccountupdatewithoutimage()!!.account(school_id, userid, addresse)
            loginResponseCall.enqueue(object : Callback<Profileupdateapi> {
                override fun onFailure(call: Call<Profileupdateapi>, t: Throwable) {
                    Log.e("@@", "e " + t.message!!)
                    Toast.makeText(context, t.message!!, Toast.LENGTH_SHORT).show()

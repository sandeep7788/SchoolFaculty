...
import com.education.Vidhyalaya_Faculty_APP.API.Changepasswordapi
...
class ChangePassword : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Picasso.with(this@ChangePassword).load("http://vidhyalaya.co.in/sspanel/"+getdata(Data.image))
